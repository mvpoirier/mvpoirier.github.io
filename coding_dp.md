...
Below are resources I've developed over the years to support teaching and student learning for the **International Baccalaureate DP Computer Science 2012 curriculum** (first exams May 2014). If you find these resources useful for use in your classes, please link to this site as part of the [Creative Commons CC BY-NC-SA 4.0 License](https://creativecommons.org/licenses/by-nc-sa/4.0/){:target="_blank"}.
