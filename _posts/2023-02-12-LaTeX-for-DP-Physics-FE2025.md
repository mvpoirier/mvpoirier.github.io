...
### Why LaTeX & Potential Uses for DP Physics
- Provides consistent display of equations, formulas, diagrams, and graphical information
- Can be used to display DP Physics equations correctly for teacher-led presentations
- Can be used for DP Physics Extended Essay writing, either as individual copy/paste of PNG or SVG Equations via [Mathcha](www.mathcha.io) __or__ as a full-fledged LaTeX document using [Overleaf] https://www.overleaf.com/project

### LaTeX Resources
- [The LaTeX Project](https://www.latex-project.org/get/)
- [Mathcha Equation Editor](www.mathcha.io)
...
### LaTeX Equation Examples with Mathcha
Source: https://www.mathcha.io/editor/nZeKei7QSeWt1d2xDviJmPMzPUdx3yZMTYvvep
